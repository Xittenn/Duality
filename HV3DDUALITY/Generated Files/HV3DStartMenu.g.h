...
namespace winrt::HV3DDUALITY::implementation
{
    ...
    struct __declspec(empty_bases) HV3DStartMenu_base : implements<D, HV3DDUALITY::HV3DStartMenu, composing, Windows::UI::Xaml::Controls::IPageOverrides, Windows::UI::Xaml::Controls::IControlOverrides, Windows::UI::Xaml::Controls::IControlOverrides6, Windows::UI::Xaml::IFrameworkElementOverrides, Windows::UI::Xaml::IFrameworkElementOverrides2, Windows::UI::Xaml::IUIElementOverrides, Windows::UI::Xaml::IUIElementOverrides7, Windows::UI::Xaml::IUIElementOverrides8, Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = HV3DStartMenu_base;
        using class_type = HV3DDUALITY::HV3DStartMenu;
        using implements_type = typename HV3DStartMenu_base::implements_type;
        using implements_type::implements_type;
        using composable_base = Windows::UI::Xaml::Controls::Page;
        hstring GetRuntimeClassName() const
        {
            return L"HV3DDUALITY.HV3DStartMenu";
        }
        HV3DStartMenu_base()
        {
...
namespace winrt::HV3DDUALITY::factory_implementation
{
    ...
    struct __declspec(empty_bases) HV3DStartMenuT : implements<D, Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = HV3DDUALITY::HV3DStartMenu;
...
#if defined(WINRT_FORCE_INCLUDE_HV3DSTARTMENU_XAML_G_H) || __has_include("HV3DStartMenu.xaml.g.h")
#include "HV3DStartMenu.xaml.g.h"
#else

namespace winrt::HV3DDUALITY::implementation
{
    template <typename D, typename... I>
    using HV3DStartMenuT = HV3DStartMenu_base<D, I...>;
}
